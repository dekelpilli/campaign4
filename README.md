...
- The following tags exist:
    ...
    - Survivability: Grants AC, spell save bonuses/adv, advantaged defence, health regen, incoming healing, outgoing healing, max HP, minion defences, change incoming damage, barrier
...
|:--------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------|
| Misc                | Randomly choose three non-miscellaneous specialisations, and then gain your choice of two of those three.                                                                                                                                                                                                  | N/A                                                                                                                  |
| Misc                | Purchasing loot results costs 75 gold, but you can only buy crafting loot results (which also grant a loot roll as per usual).                                                                                                                                                                             | N/A                                                                                                                  |
| Misc                | You have an additional regular item slot, which can accept both glove and armour type enchants/uniques/relics, but you cannot wear more than two curio-crafted items, two relics, or two uniques at one time.                                                                                              | N/A                                                                                                                  |
| Misc                | The outcomes of your non-crafting loot rolls have a 40% chance to be replaced by a carnival ticket associated with that loot result type, and gold costs associated with carnival stands are halved for you.                                                                                               | N/A                                                                                                                  |
...
| Curios              | +1 to your curio crafts' points targets.                                                                                                                                                                                                                                                                   | Other characters must sacrifice catalysts to use items crafted by you, provided their points target was less than 7. |
| Curios              | Once after crafting an item with curios, you can use a catalyst to upgrade one modifier on that item at random.                                                                                                                                                                                            | Items upgraded in this way can't be used by other characters.                                                        |
...
| Divine Dust         | Choose one divinity path you have completed and itemise it, allowing you to wear it as an enchanted item on one of your armour or glove slots. This path is no longer tied to your character, and you may choose another path to immediately finish.                                                       | Other characters cannot wear the itemised path, and it cannot be sold.                                               |
| Divine Dust         | Whenever you finish a divine path, gain a spell related to this divine path. You may cast these spells an amount of times per long rest equal to the number of divine paths you have finished.                                                                                                             | N/A                                                                                                                  |
...
| Tarot (77-88)       | Levelling relics beyond level 6 only costs 2 relic dust (instead of 3).                                                                                                                                                                                                                                    | Relics levelled in this way require an appropriate relic dust sacrifice in order to be used by other characters.     |
...
| Uniques (89-100)    | When you find a unique item, it has a 50% chance to be at level 2.                                                                                                                                                                                                                                         | Uniques found at level 2 are considered to be level 1 when used by other characters.                                 |
...
| Uniques             | When you level up a unique item, the resulting (levelled) unique item is duplicated, allowing you to wear it twice or salvage one for an Ancient Orb.                                                                                                                                                      | The duplicated uniques can only be worn by you, and cannot be used to feed into other uniques to level them.         |
