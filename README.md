...
### Helmets
- Character enchants only, spawn with 2 points of mods
...
| Divine Dust | You always have a secondary divine path which you choose. Whenever you use divine dust, you have a 50% chance to also progress your secondary divine path. When you finish a path, you may choose for your secondary path to become your new main path. | N/A                                                                                                        |
| Divine Dust | Your divinity paths have unlock a sixth tier. If this causes you to have multiple unfinished paths, choose which one to progress when you use divine dust.                                                                                              | N/A                                                                                                        |
| Divine Dust | Choose one divinity path your have finished and itemise it, allowing you to wear it as an enchanted item on one of your armour or glove slots. This path is no longer tied to your character, and you may choose another path to immediately finish.    | Other characters cannot wear the itemised path, and it cannot be sold.                                     |
...
| Helmets     | Whenever you receive a helmet loot result, you may choose to provide a theme for a new mod to be added to the pool. Additionally, you may permanently remove one mod on the found helmet from the mod pool. These decisions take effect next session.   | N/A                                                                                                        |
...
| Rings       | Instead of only receiving one ring when sacrificing rings, receive 1 for every 3 rings sacrified, to a minimum of 1.                                                                                                                                    | Only one ring received from each of your ring sacrifices can be used by other characters.                  |
